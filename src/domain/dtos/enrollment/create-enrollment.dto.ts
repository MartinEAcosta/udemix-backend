...
export class CreateEnrollmentDto {
    ...
    static create = ( props : {[ key : string ]: any} ) : [string? , CreateEnrollmentDto?] => {
        const { id_user , id_course , purchaseDate , progress , completionDate } = props;
        ...
        return [ undefined , new CreateEnrollmentDto( id_user , id_course , purchaseDate , progress , completionDate )];
    }
